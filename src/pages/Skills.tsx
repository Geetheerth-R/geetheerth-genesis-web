      ...
      <main className="flex-grow pt-24 pb-16">
        <div className="container mx-auto">
          <div className="flex flex-col items-center text-center mb-12">
            <h1 className="font-bold mb-4 font-poppins text-3xl">My Skills</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {skillCategories.map((category, index) => <div key={index} className="bg-dark-100 p-6 rounded-xl shadow-lg">
                ...
                <div className="space-y-6">
                  {category.skills.map((skill, skillIndex) => <div key={skillIndex}>
                      ...
                      <Progress value={skill.level} className="h-2 bg-dark-200">
                        <div className="h-full bg-gradient-to-r from-tech-blue to-tech-purple rounded-full" style={{
                    width: `${skill.level}%`
                  }} />
                      </Progress>
                    </div>)}
          ...
          <div className="mt-16 bg-dark-100 p-8 rounded-xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
              {["IoT", "JavaScript", "Python", "Java", "C++", "Node.js", "AI", "Flask", "MySQL", "Node-RedL", "MQTT", "Windows", "UI/UX", "Chatbot", "Database", "SAP", "CAD", "Linux", "Sensors", "Actuators"].map((tech, i) => <div key={i} className="bg-dark-200 px-4 py-3 rounded-lg text-center hover:bg-dark-300 transition-colors">
                  {tech}
                </div>)}
            </div>
          </div>
            ...
            <div className="max-w-3xl mx-auto bg-dark-100 p-8 rounded-xl">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="border border-tech-red/30 rounded-lg p-5 bg-dark-200">
                  <h3 className="text-lg font-medium mb-3 text-tech-red">Artificial Intelligence</h3>
                  <p className="text-muted-foreground text-sm">Learning about the AI models and the way they can be used in our day to day life and implementing it in it.</p>
                </div>
